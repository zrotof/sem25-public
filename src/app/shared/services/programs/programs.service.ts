...
export class ProgramsService {
  ...
  programs = [
  {
    ...
    "list": [
      ...
      "Promouvoir les langues nationale et locale dans l’éducation, les médias et l’administration",
  ...
  },
  {
    ...
    "list": [
      "Profil d’homme à former : homme réel ou une image cible. Il s’agit d’un homme qui est maître de lui-même, ouvert à tous les échanges, critiques et non conformiste, c’est-à-dire capable de dire non. Inséré dans son époque, insatisfait et constamment en quête de dépassement. Éternel insatisfait c’est-à-dire en train de se remettre en question, de douter, de ne prendre rien pour acquis",
      ...
      "Mettre en œuvre de Nouveaux niveaux d’enseignement : Éducation et protection de la petite enfance (0 à 3 ans) ; réforme du niveau post primaire non secondaire ; enseignement post secondaire non supérieur",
      ...
      "Créer un fonds pour la recherche et collaboration entre les laboratoires universitaires et les structures institutionnelles publiques pour les études et autres prestations intellectuelles",
    ...
    "summary": "Une éducation décolonisée et patriotique pour le Cameroun. Il s'agit de réformer les programmes scolaires pour former des citoyens critiques et autonomes, d'adapter le calendrier scolaire, et de créer des universités techniques. Le financement de ce système est assuré par une taxation sur les produits manufacturés et l'exploitation des ressources naturelles."
  },
  {
    ...
    "summary": "Pour faire de la culture un levier d'émancipation, un fonds national soutient les artistes et les industries culturelles. Il s'agit aussi de valoriser le patrimoine, de promouvoir les danses et musiques traditionnelles, et de créer des lycées artistiques dans chaque département pour former les jeunes talents."
  },
  {
    "id": "sport_jeunesse",
    ...
    "list": [
      ...
      "Ces lycées porteront les noms des icônes du sport camerounais. Ceux qui ont porté le nom Cameroun au panthéon africain et surtout mondial dans leur discipline respective. Il y aura par exemples les lycées Roger Mila, Samuel Eto’o, Mboma, Njitap, Françoise Mbango, Sara Etongue, Aboudi Onguené, etc. Cette attribution de nom porte aussi une logique de parrainage",
      ...
      "Développement des éléments qui facilitent la pratique du sport, de la tenue des compétitions sportives et l’économie du sport. Les communes et les régions relativement à leur environnement vont construire des complexes sportifs, des stades et autres infrastructures pour faciliter la politique sportive du PURS. Celles-ci se feront avec le partenariat de l’initiale privée (les promoteurs physiques ou moraux de clubs), la coopération décentralisée, la diaspora, les ressortissants de ces CTD ayant réussi dans le domaine du sport, les populations, etc. Chaque région et commune au bout du mandat présidentiel développeront ces infrastructures.",
      "Au niveau des lycées et universités de sports les parrains, l’Etat, les fédérations, les gains des compétitions, les CTD, les projets de coopérations avec les clubs sportifs, les anciens élèves ou étudiants, etc., faciliteront la construction des infrastructures nécessaires à la réalisation de l’action pédagogique ici.",
      "Pour ce qui est des écoles primaires, lycées et universités dits ordinaires, le développement des infrastructures se feront avec le fruit des impôts pour l’éducation, les CTD, les fruits des compétitions auxquelles prennent part le Cameroun.",
  ...
  },
  {
    ...
    "summary": "La cohésion nationale se renforce en réconciliant les mémoires et en garantissant une justice sociale. La politique vise une répartition équitable des ressources entre les régions, encourageant une participation citoyenne pour que chaque Camerounais, qu'il soit anglophone ou francophone, se sente solidaire et fier de contribuer à l'unité de la nation."
  },
  {
    ...
    "summary": "L'État se décentralise de manière équitable et renforce la justice sociale. Cela passe par un redécoupage administratif (de 10 à 5 régions, de 58 à 30 départements), une réduction à 15 ministères et la création d'une fonction publique territoriale qui génèrera 100 000 emplois directs."
  },
  {
    "id": "habitat_logement",
    ...
    "list": [
      ...
      "Ramener le prix du sac de ciment à 2000 pour permettre aux Camerounais de construire un logement à 3 000 000. Ceci grâce à la reprise du gisement du clinker de Figuil et l’industrialisation des carrières de poussolane.",
    ...
    "summary": "Assurer un toit sur chaque tête passe par une refonte foncière, la réduction du prix du ciment à 2000 FCFA et la construction de 100 000 logements. Des banques et des fonds de l'habitat sont créés pour financer les projets, et des programmes d'insertion économique sont mis en place dans les villages pour contrer l'exode rural."
  },
  {
    ...
    "list": [
      ...
      "Allocation pour l’acquisition du matériel d’aide à la mobilité des personnes handicapées",
      "Assurer l’insertion professionnelle des personnes handicapées",
      "Encourager les personnes handicapées à accéder aux postes de responsabilité administrative et politiques (Une personne handicapée sera nommée membre du gouvernement)"
    ],
    "summary": "Une meilleure inclusion des personnes handicapées est garantie par la facilitation de l'accès à la carte d'invalidité et à des allocations pour le matériel de mobilité. Le programme encourage leur insertion professionnelle et leur accès aux postes de responsabilité, s'engageant même à nommer une personne handicapée au gouvernement."
  },
  {
    ...
    "list": [
      ...
      "Mise en place des institutions fortes (Agence Nationale de lutte contre la corruption au Cameroun qui aura les compétences de toutes les structures existantes actuelles ; la cours des comptes)",
      "Amélioration des conditions de vie et de travail des agents publics",
    ...
    "summary": "La souveraineté politique et la gouvernance sont renforcées par un référendum pour une nouvelle constitution. Une agence nationale de lutte contre la corruption est mise en place, les conditions des agents publics sont améliorées, et un nouveau système judiciaire est créé pour des institutions fortes."
  },
  {
    "id": "souverainete_economique",
    "title": "Souveraineté économique et industrielle",
    "description": "Industries, entreprises, fiscalité et emploi : la production comme levier de l’économique traduit par une industrialisation volontariste, courageuse et plurielle.",
    "list": [
      ...
      "Mettre en place un fond de garanti de souveraineté de 300 Milliards de Franc CFA chaque année pour le développement et la création d’un million d’entreprises (PME/PMI) pour au moins 5 millions d’emploi directs en 5 ans"
    ],
  ...
  },
  {
    ...
    "title": "Souveraineté énergétique et écologique : Énergie renouvelables, lutte contre la pollution, agriculture durable",
    "description": "",
    "list": [
      "Réalisation du projet de modernisation de la SONARA afin de lui permettre de disposer la technologie nécessaire pour raffiner le pétrole produit au Cameroun.",
      ...
      "Construction de nouvelles stations de traitement des eaux, le renouvellement des équipements, des conduites, des branchements existant en vue de sécuriser l’alimentation en eau potable",
      "Décentralisation de la gestion de l’eau et de la placer sous la responsabilité des communes",
  ...
  },
  {
    ...
    "description": "",
    "list": [
      "Créer la caisse maladie où chaque citoyen cotisera 1000 par mois pour l’assurance maladie. Cette caisse servira à la gratuité des soins de santé,",
      "Améliorer le plateau technique et mise en place d’un fonds spécial pour la recherche sur les plantes médicinales et valorisation de la pharmacopée",
      ...
      "Maintenir les Camerounais dans un état meilleur de fonctionnement et donner la possibilité d’évoluer dans",
      "Renforcer les budgets des unités de recherches dans les universités et instituts",
  ...
  },
  {
    ...
    "list": [
      ...
      "1000 milliard d’investissement dans l’agriculture les deux premières années"
    ],
    "summary": "Le pays renforce sa sécurité en viabilisant ses frontières et en réformant ses forces de défense et de sécurité. Un institut de recherche sur la sécurité est créé et les conditions des agents publics sont améliorées. Un investissement massif de 1000 milliards de FCFA est aussi prévu pour l'agriculture, qui est considérée comme un pilier de la sécurité alimentaire."
  },
  {
    "id": "diplomatie_diaspora",
    "title": "Diplomatie & diaspora comme leviers de souveraineté: deux entités incontournables de la réussite du programme",
    "description": "",
    "list": [
      ...
      "Des consulats pour un meilleur encadrement des Camerounais, seront ouverts. L’idée est de sécuriser tout camerounais partout où ils décident d’aller faire fortune à travers les études, les activités économiques et culturelles ou la filiation.",
